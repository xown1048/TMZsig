...
table(df3$ALT)
#Deletions Inversions Tandem-duplications Translocations
#964       136        103                 68
#3708      1883       1553                164
...
pdf(file=file.path(output.dir, 'figure1.h.no.read.filter.sv.p10.10gen.barplot.pdf'), width=100, height=65)
ggplot(df7, aes(x=Sample, y=Count)) +
