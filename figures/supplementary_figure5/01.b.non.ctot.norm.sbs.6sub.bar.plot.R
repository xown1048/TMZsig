...
merge.df = merge.df[merge.df$MutationType!='C>T',]
...
#####	Cosmic signature colors [Non C>T]
...
pdf(file=file.path(output.dir, '08.review3.14_non.ctot.norm.sbs.6sub.bar.plot.pdf'), width=200, height=30)
...
pdf(file=file.path(output.dir, '08.review3.14_non.ctot.norm.sbs.6sub.bar.plot.pdf'), width=200, height=40)
