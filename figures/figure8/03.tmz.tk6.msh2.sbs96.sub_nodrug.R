...
df3 = df2[df2$Group %in% c('MSH2-TK6-nodrug', 'MSH2-TK6-500microM-TMZ'),]
...
pdf(file=file.path(output.dir, 'figure6.3.tmz.tk6.msh2.sbs96.sub_nodrug.pdf'), width=90, height=30)
