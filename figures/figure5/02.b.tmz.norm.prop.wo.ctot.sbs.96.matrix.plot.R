...
output.dir = '/BiO/Research/UNIST-Toni-Sig-2020-1026/figures/part2.10'
if(!dir.exists(output.dir)){dir.create(output.dir)}
output.dir = '/BiO/Research/UNIST-Toni-Sig-2020-1026/figures/part2.10/output'
if(!dir.exists(output.dir)){dir.create(output.dir)}
output.dir = '/BiO/Research/UNIST-Toni-Sig-2020-1026/figures/part2.10/output/figure5'
if(!dir.exists(output.dir)){dir.create(output.dir)}
...
pdf(file=file.path(output.dir, 'figure5.b.tmz.nrom.prop.merge.sbs96.matrix.plot.pdf'), width=200, height=80)
