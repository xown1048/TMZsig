...
df8 = df8[df8$Gene %in% c('MSH2', 'MSH2_MPG', 'MSH2_RAD18', 'FANCD2_MSH2', 'ATAD5_MSH2', 'MSH2_XRCC1', 'MSH2_REV1', 'MSH2_REV7'),]
...
pdf(file=file.path(output.dir, 'figure5.b.no.read.filter.norm.1uM.msh2.sv.5class.barplot.pdf'), width=100, height=60)
