...
df3 = df2[df2$Group %in% c('MSH2_REV7-TK6-nodrug', 'MSH2_REV7-TK6-160microM-TMZ'),]

###########################################################################################################################
groups = unique(df3$Group)
wt.group = 'MSH2_REV7-TK6-nodrug'
...
pdf(file=file.path(output.dir, 'figure6.5.tmz.tk6.msh2.rev7.sbs96.sub_nodrug.pdf'), width=90, height=30)
