...
df3 = df2[df2$Gene %in% c('WT', 'POLB'),]
df3 = df3[df3$MutationType == '2:Del:R:5',]
...
pdf(file=file.path(output.dir, 'extended.figure4.c.repeat.del.norm.1uM.polb.indel.5class.barplot.pdf'), width=100, height=60)
